...
var ASM_CONSTS = {
 ...
 1086058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086126: () => { document.exitFullscreen(); },  
 1086153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086226: () => { if (document.fullscreenElement) return 1; },  
 1086272: () => { return document.getElementById('canvas').width; },  
 1086324: () => { return screen.width; },  
 1086349: () => { document.exitFullscreen(); },  
 1086376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086509: () => { if (document.fullscreenElement) return 1; },  
 1086555: () => { return document.getElementById('canvas').width; },  
 1086607: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086675: () => { if (document.fullscreenElement) return 1; },  
 1086721: () => { return document.getElementById('canvas').width; },  
 1086773: () => { return screen.width; },  
 1086798: () => { if (document.fullscreenElement) return 1; },  
 1086844: () => { return document.getElementById('canvas').width; },  
 1086896: () => { return screen.width; },  
 1086921: () => { document.exitFullscreen(); },  
 1086948: () => { if (document.fullscreenElement) return 1; },  
 1086994: () => { return document.getElementById('canvas').width; },  
 1087046: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087114: () => { document.exitFullscreen(); },  
 1087141: () => { return screen.width; },  
 1087166: () => { return screen.height; },  
 1087192: () => { return window.screenX; },  
 1087219: () => { return window.screenY; },  
 1087246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1087427: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1087498: () => { if (document.fullscreenElement) return 1; },  
 1087544: () => { if (document.pointerLockElement) return 1; }
};
