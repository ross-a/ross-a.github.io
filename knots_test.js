...
var ASM_CONSTS = {
  1086216: () => { if (document.fullscreenElement) return 1; },  
 1086262: () => { return document.getElementById('canvas').width; },  
 1086314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086382: () => { document.exitFullscreen(); },  
 1086409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086482: () => { if (document.fullscreenElement) return 1; },  
 1086528: () => { return document.getElementById('canvas').width; },  
 1086580: () => { return screen.width; },  
 1086605: () => { document.exitFullscreen(); },  
 1086632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086765: () => { if (document.fullscreenElement) return 1; },  
 1086811: () => { return document.getElementById('canvas').width; },  
 1086863: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086931: () => { if (document.fullscreenElement) return 1; },  
 1086977: () => { return document.getElementById('canvas').width; },  
 1087029: () => { return screen.width; },  
 1087054: () => { if (document.fullscreenElement) return 1; },  
 1087100: () => { return document.getElementById('canvas').width; },  
 1087152: () => { return screen.width; },  
 1087177: () => { document.exitFullscreen(); },  
 1087204: () => { if (document.fullscreenElement) return 1; },  
 1087250: () => { return document.getElementById('canvas').width; },  
 1087302: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087370: () => { document.exitFullscreen(); },  
 1087397: () => { return screen.width; },  
 1087422: () => { return screen.height; },  
 1087448: () => { return window.screenX; },  
 1087475: () => { return window.screenY; },  
 1087502: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087555: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087626: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1087683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1087754: () => { if (document.fullscreenElement) return 1; },  
 1087800: () => { if (document.pointerLockElement) return 1; }
};
